(defun color-theme-rlx ()
  ...
  (color-theme-install
   '(color-theme-rlx
     ...
     (ido-first-match ((t (:foreground "yellowgreen"))))
     (ido-first-match-face ((t (:foreground "yellowgreen"))))
     (ido-indicator-face ((t (nil))))
     (ido-only-match ((t (:foreground "yellowgreen"))))
     (ido-only-match-face ((t (:foreground "yellowgreen"))))
     (ido-subdir ((t (nil))))
